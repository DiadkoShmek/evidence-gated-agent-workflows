...
class PublicationCandidateTest(unittest.TestCase):
    ...
    def test_architecture_note_is_runnable_bounded_and_linked(self) -> None:
        ...
        self.assertIn("seven small owners", architecture)
        self.assertNotIn("six small owners", architecture)
        ...
        self.assertIn("local-context-review-ready", readme)
    ...
    def test_one_command_proof_pins_valid_fixture_epoch_and_expected_decision(self) -> None:
        ...
        self.assertIn('ROOT / "bounded-rag-review"', runner)
        self.assertIn('"test_bounded_rag_review.py"', runner)
